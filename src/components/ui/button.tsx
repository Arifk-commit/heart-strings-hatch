    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        soft: "bg-secondary text-secondary-foreground hover:bg-primary hover:text-primary-foreground",
        glass: "border border-surface-glass-border bg-surface-glass text-foreground shadow-sm backdrop-blur-md hover:bg-background",
        teal: "bg-teal text-teal-foreground shadow-sm hover:bg-teal/90",
        footer: "border border-ink-border bg-transparent text-ink-foreground hover:bg-ink-soft",
      },
      size: {
